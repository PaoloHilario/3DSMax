...
-- on objects that are part of your scenery (ie, objects that should recieve
-- shadows from non Matte objects such as ground planes).
-------------------------------------------------------------------------------
...
-- Use on objects that are part of your scenery (ie, objects that should recieve
-- shadows from non Matte objects such as ground planes).
--
...
undo "AssignSceneMatte" on
	(
	m = copy (get_blurmat "Matte_Scene")
	for i in selection do
		(
		i.material = m
		)
