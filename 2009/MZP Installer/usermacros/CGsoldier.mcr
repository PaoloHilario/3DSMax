...
fileIn "$userscripts\\CGsoldier\\functions\\BSStartup.mse"
...
MacroScript CGS_MT category:"CGS-Launch" tooltip:"CGsoldier Modeling Tools" Icon:#("CGsoldier", 12)
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools.mse"
	)

MacroScript CGS_ST category:"CGS-Launch" tooltip:"CGsoldier Scene Tools" Icon:#("CGsoldier",2)
	(
	FileIn "$userscripts\\CGsoldier\\CGS-SceneTools.mse"
	)
	
MacroScript CGS_RD category:"CGS-Launch" tooltip:"CGsoldier R&D Scripts" Icon:#("CGsoldier", 3)
	(
	FileIn "$userscripts\\CGsoldier\\CGS-R&DTools.mse"
	)

MacroScript BSRun category:"CGS-Launch" tooltip:"Blur Scripts" Icon:#("CGS-BlurScripts",51)
	(
	FileIn "$userscripts\\BlurScripts\\BSRun.mse"
	)
...
MacroScript PassMonkey category:"CGS-SceneTools" tooltip:"CGS-PassMonkey" Icon:#("CGsoldier", 1)
	(
	FileIn "$userscripts\\CGsoldier\\CGS-SceneTools\\CGS-PassMonkey.mse"
	)
	
MacroScript RenderMonkey category:"CGS-SceneTools" tooltip:"CGS-RenderMonkey" Icon:#("CGsoldier", 2)
	(
	FileIn "$userscripts\\CGsoldier\\CGS-SceneTools\\CGS-RenderMonkey_V1.mse"
	)
	
MacroScript RenderMonkey category:"CGS-SceneTools" tooltip:"CGS-RenderMonkey" Icon:#("CGsoldier", 2)
	(
	FileIn "$userscripts\\CGsoldier\\CGS-SceneTools\\CGS-RenderMonkey_V2.mse"
	)
...
MacroScript AutoWeld category:"CGS-ModelingTools" tooltip:"Autoweld Pivot"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\AutoWeld.mse"
	)
...
MacroScript ClearMats category:"CGS-ModelingTools" tooltip:"Clear Materials"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Clear_Mats.mse"
	)
	
MacroScript ContourSlicer category:"CGS-ModelingTools" tooltip:"Contour Slicer"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Contour_Slicer.mse"
	)
		
MacroScript FastBoolAB category:"CGS-ModelingTools" tooltip:"FastBool (A)-(B)"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Fast_Boolean_AminusB.mse"
	)

MacroScript FastBoolIntersect category:"CGS-ModelingTools" tooltip:"FastBool Intersect"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Fast_Boolean_Intersect.mse"
	)

MacroScript FastBoolUnion category:"CGS-ModelingTools" tooltip:"FastBool Union"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Fast_Boolean_Union.mse"
	)
	
MacroScript KeepMapCollapse category:"CGS-ModelingTools" tooltip:"KeepMap Collapse"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Keep_Map_Collapse.mse"
	)

MacroScript KeepMapCollapseMesh category:"CGS-ModelingTools" tooltip:"KeepMap Collapse-Mesh"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Keep_Map_Collapse_Mesh.mse"
	)
	
MacroScript KeepMapCollapsePoly category:"CGS-ModelingTools" tooltip:"KeepMap Collapse-Poly"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Keep_Map_Collapse_Poly.mse"
	)
...
MacroScript Kill_All_Mods category:"CGS-ModelingTools" tooltip:"Kill All Modifiers"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Kill_All_Modifiers.mse"
	)
...
MacroScript LightsSelectedOFF category:"CGS-ModelingTools" tooltip:"Lights-Selected_OFF"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Lights-Selected_Off.mse"
	)

MacroScript LightsSelectedON category:"CGS-ModelingTools" tooltip:"Lights-Selected_ON"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Lights-Selected_On.mse"
	)
	
MacroScript LightsSelectedONLY category:"CGS-ModelingTools" tooltip:"Lights-Selected_ONLY"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Lights-Selected_On_Only.mse"
	)
	
MacroScript LoftDividerGRASS category:"CGS-ModelingTools" tooltip:"LoftDivider-Grass"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\LoftDivider-Grass.mse"
	)
	
MacroScript LoftDividerENGLISH category:"CGS-ModelingTools" tooltip:"LoftDivider-English Units"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\LoftDivider-UnitsEnglish.mse"
	)
...
MacroScript NSexporter category:"CGS-ModelingTools" tooltip:"Named Selections-Exporter"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\named_selections_exporter.mse"
	)
	
MacroScript NSimporter category:"CGS-ModelingTools" tooltip:"Named Selections-Importer"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\named_selections_importer.mse"
	)
	
MacroScript ObjectCollapser category:"CGS-ModelingTools" tooltip:"Object Collapser"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Object_Collapser.mse"
	)
...
MacroScript PathRemapper category:"CGS-ModelingTools" tooltip:"Path Remapper"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Path_Remapper.mse"
	)
	
MacroScript PivotCenter category:"CGS-ModelingTools" tooltip:"Pivot-Center"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Pivot_Center.mse"
	)
...
MacroScript PivotMatch category:"CGS-ModelingTools" tooltip:"Pivot-Match"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Pivot_Match.mse"
	)
	
MacroScript PivotMinZ category:"CGS-ModelingTools" tooltip:"Pivot-Min Z"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Pivot_Min_Z.mse"
	)
...
MacroScript RWK_Cage_Import category:"CGS-ModelingTools" tooltip:"Reference Rotate"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Reference_Rotate.mse"
	)
	
MacroScript RWK_Calculator category:"CGS-ModelingTools" tooltip:"Reference Scale"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Reference_Scale.mse"
	)
	
MacroScript RWK_Calculator category:"CGS-ModelingTools" tooltip:"Rockwork Calculator"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\RockWork_Calculator.mse"
	)

MacroScript RoofMonkey category:"CGS-ModelingTools" tooltip:"Roof Monkey"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Roof_Monkey.mse"
	)
	
MacroScript SelectionDrop category:"CGS-ModelingTools" tooltip:"Selection Drop"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Selection_Drop.mse"
	)
	
MacroScript TempMerge category:"CGS-ModelingTools" tooltip:"Temp-Merge"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Temp_Merge.mse"
	)
	
MacroScript TempSaveSelected category:"CGS-ModelingTools" tooltip:"Temp-Save Selected"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Temp_Save_Selected.mse"
	)
...
MacroScript UVWpastecopy category:"CGS-ModelingTools" tooltip:"UVW-Paste as Copy"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\UVW_Paste_Copy.mse"
	)
	
MacroScript UVWpasteinstance category:"CGS-ModelingTools" tooltip:"UVW-Paste as Instance"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\UVW_Paste_Instance.mse"
	)
	
MacroScript Variegator category:"CGS-ModelingTools" tooltip:"Variegator"
	(
	FileIn "$userscripts\\CGsoldier\\CGS-ModelingTools\\Variegator.mse"
	)
